 ...
 */
static const char *fonts[]     = {"Hack:weight=bold:size=10:antialias=true:hinting=true",
                                  "Hack:size=10:antialias=true:autohint=true",
                                  "JoyPixels:size=12:antialias=true:autohint=true"
						     	};
static const char col_1[]  = "#1c1c1c"; /* background color of bar */
static const char col_2[]  = "#282c34"; /* border color unfocused windows */
static const char col_3[]  = "#d7d7d7";
static const char col_4[]  = "#b14fb8"; /* border color focused windows and tags */
/* bar opacity
...
static Keychord keychords[] = {
	...
	{1, {{MODKEY, XK_x}}, spawn,          {.v = dmenucmd } },
