...
static const char *fonts[]          = {
	"JetBrains Mono:size=11:style=Medium",
	"JoyPixels:size=11",
	"JetBrains Mono:size=11:style=Medium",
...
static char background[] = "#232324";
static char color16[][8] = {
	"#000000", "#AA0000", "#00AA00", "#AAAA00",
	"#0000AA", "#AA00AA", "#B200FF", "#AAAAAA",
...
static const char *tags_busy[] = { "1", "2", "3", "4", "5" };
static const char *tags_curr[] = { "1", "2", "3", "4", "5" };
